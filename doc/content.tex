...
%[Shimura--Taniyama--Weil conjecture: $a_p$ version]
	...
	\lean{modularity_conjecture.modularity_conjecture}
	\leanok
...
\begin{definition}\label{defn:mod_gal_rep}
	\uses{defn:unram_gal_rep,defn:hecke_alg, defn:ab_var_mod_form,defn:mod_curve_0,defn:mod_form_gal_rep }
...
\begin{theorem}\label{equivs_modular}
	\uses{defn:L_fn_modularity,thm:mod_conj_ap,defn:ell_curve_gal_rep,defn:mod_gal_rep,defn:ab_var_mod_form} 
